...
If you have not set up [awscli](https://aws.amazon.com/cli/), you can simply drag the files in the `dist` repo, generated by running `npm run deploy`, into the folder you created on AWS.

If you prefer to automate deploy, here are the requirements:
...
In `Makefile`, replace `year/month/name` with your own (eg. `2019/09/sport`). Uncomment code.
